...
class AccessCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access_code" do
    assert_difference("AccessCode.count") do
      post access_codes_url, params: { access_code: { code: @access_code.code, name: @access_code.name, storage_unit_id: @access_code.storage_unit_id } }
    end
  ...
  test "should update access_code" do
    patch access_code_url(@access_code), params: { access_code: { code: @access_code.code, name: @access_code.name, storage_unit_id: @access_code.storage_unit_id } }
